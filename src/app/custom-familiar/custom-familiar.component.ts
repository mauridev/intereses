...
@Component({
  selector: 'app-custom-familiar',
  templateUrl: './custom-familiar.component.html',
  styleUrls: ['./custom-familiar.component.css']
})
export class CustomFamiliarComponent implements OnInit {
